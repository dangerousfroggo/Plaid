https://platform.openai.com/docs/api-reference/introduction    -- request template from here has been used, used to learn specific methods for openai api (already had some previous knowledge of basics)
